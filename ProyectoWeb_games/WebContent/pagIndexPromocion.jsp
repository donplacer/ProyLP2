	...
	<div id="body">
		...
		<header>
			...
			<div id="encabezado">
				...
				<article class="cajasHeader">
					<form class="Contenedor-Busquedad" action="" >
		...
		<div id="principal" style="margin-top: 30px;margin-bottom: 40px;">
			...
			<section id="contenedorPrincipal" >
				...
				<div class=" border-left articulos ">

					<div id="titulo_articulo" style="margin-top: 60px;">
						<h2>Promociones</h2>
